...
Comment.create!(value: "Please can you also make a video on you creating chrome browser and also giving some tips on
how to be proficient in JavaScript and also some code problem solving techniques.", article_id: 1, user_id: 1)
Comment.create!(value: "Sir will you plz make some new react Js easy and beautiful projects that consists of clones
and other new website designs.", article_id: 2, user_id: 2)
Comment.create!(value: "Well, I am successfully created medium clone with help of this video greeaaaatt succes.",
                article_id: 3, user_id: 3)
Comment.create!(value: "Can you make a serious flutter tutorial?", article_id: 4, user_id: 4)
Comment.create!(value: "Hey dude I don't have card to use firebase in need card details what I do help me out?",
                article_id: 5, user_id:5)
